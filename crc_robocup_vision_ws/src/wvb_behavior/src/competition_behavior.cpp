...
public:
  ...
  : Node("competition_behavior")
  {
    ...
    detection_sub_ = create_subscription<wvb_interfaces::msg::TargetDetection>(
      target_detection_topic_, 10,
      [this](const wvb_interfaces::msg::TargetDetection::SharedPtr msg) {
        last_detection_ = *msg;
...
private:
  ...
  bool is_own_detection(const wvb_interfaces::msg::TargetDetection & detection) const
  {
  ...
  bool is_aligned(const wvb_interfaces::msg::TargetDetection & detection) const
  {
  ...
  wvb_interfaces::msg::TargetDetection last_detection_;
  ...
  rclcpp::Subscription<wvb_interfaces::msg::TargetDetection>::SharedPtr detection_sub_;
