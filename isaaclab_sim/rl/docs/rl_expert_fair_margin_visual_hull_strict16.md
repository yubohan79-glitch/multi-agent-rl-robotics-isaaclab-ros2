...
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 4.5625 |
...
| `base_rush_steps_per_episode` | 225.8125 |
| `wall_time_s` | 85.848 |

## Output Files

- JSON summary: `isaaclab_sim/rl/isaaclab_sim/output/replay/expert_fair_margin_visual_hull_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/rl/isaaclab_sim/output/replay/expert_fair_margin_visual_hull_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/rl/isaaclab_sim/output/replay/expert_fair_margin_visual_hull_strict16/strict_replay_events.jsonl`
