...
| `yellow_win_rate` | 0.5 |
| `blue_win_rate` | 0.25 |
| `draw_or_timeout_rate` | 0.25 |
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 4.5 |
| `base_wins_per_episode` | 0.75 |
| `own_target_penalties_per_episode` | 0.0 |
| `blocked_steps_per_episode` | 0.0 |
| `target_contact_events_per_episode` | 0.0 |
| `robot_contacts_per_episode` | 5.5 |
| `recovery_events_per_episode` | 0.0 |
| `block_steps_per_episode` | 186.125 |
| `base_rush_steps_per_episode` | 356.125 |
| `wall_time_s` | 105.617 |

## Output Files

- JSON summary: `isaaclab_sim/rl/isaaclab_sim/output/replay/mappo_dual_experts_contact_hull_seed260507_bluetuned_strict8/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/rl/isaaclab_sim/output/replay/mappo_dual_experts_contact_hull_seed260507_bluetuned_strict8/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/rl/isaaclab_sim/output/replay/mappo_dual_experts_contact_hull_seed260507_bluetuned_strict8/strict_replay_events.jsonl`
