...
| --- | ---: |
| `episodes` | 64 |
| `yellow_win_rate` | 0.6719 |
| `blue_win_rate` | 0.3281 |
| `draw_or_timeout_rate` | 0.0 |
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 4.8594 |
...
| `robot_contacts_per_episode` | 0.0312 |
| `recovery_events_per_episode` | 0.0 |
| `block_steps_per_episode` | 1.8125 |
| `base_rush_steps_per_episode` | 228.8125 |
| `wall_time_s` | 378.955 |

## Output Files

- JSON summary: `isaaclab_sim/rl/isaaclab_sim/output/replay/expert_fair_visual_hull_strict64/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/rl/isaaclab_sim/output/replay/expert_fair_visual_hull_strict64/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/rl/isaaclab_sim/output/replay/expert_fair_visual_hull_strict64/strict_replay_events.jsonl`
