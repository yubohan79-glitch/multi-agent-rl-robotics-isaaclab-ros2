...
| `block_steps_per_episode` | 1.0 |
| `base_rush_steps_per_episode` | 242.5 |
| `wall_time_s` | 95.522 |

## Output Files

- JSON summary: `isaaclab_sim/rl/isaaclab_sim/output/replay/expert_fair_blue_comp_visual_hull_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/rl/isaaclab_sim/output/replay/expert_fair_blue_comp_visual_hull_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/rl/isaaclab_sim/output/replay/expert_fair_blue_comp_visual_hull_strict16/strict_replay_events.jsonl`
