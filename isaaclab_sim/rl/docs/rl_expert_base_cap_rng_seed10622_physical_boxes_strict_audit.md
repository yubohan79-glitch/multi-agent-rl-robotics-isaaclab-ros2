...
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 3.0 |
| `base_wins_per_episode` | 0.0 |
| `own_target_penalties_per_episode` | 0.0 |
| `blocked_steps_per_episode` | 3264.0 |
| `target_contact_events_per_episode` | 0.0 |
| `robot_contacts_per_episode` | 0.0 |
| `recovery_events_per_episode` | 1.0 |
| `block_steps_per_episode` | 350.0 |
| `base_rush_steps_per_episode` | 1179.0 |
| `wall_time_s` | 20.162 |

## Output Files

- JSON summary: `isaaclab_sim/rl/isaaclab_sim/output/replay/expert_base_cap_rng_seed10622_physical_boxes/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/rl/isaaclab_sim/output/replay/expert_base_cap_rng_seed10622_physical_boxes/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/rl/isaaclab_sim/output/replay/expert_base_cap_rng_seed10622_physical_boxes/strict_replay_events.jsonl`
