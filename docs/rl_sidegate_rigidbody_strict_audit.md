...
- checkpoint: `isaaclab_sim/output/rl/mappo_sidegate_rigidbody_seed505/policy.pt`
- deterministic: `False`
- device: `cuda`
- episodes: `16`
...
| --- | ---: |
| `episodes` | 16 |
| `yellow_win_rate` | 0.3125 |
| `blue_win_rate` | 0.625 |
| `draw_or_timeout_rate` | 0.0625 |
| `hard_violations` | 0 |
| `warnings` | 166 |
| `normal_hits_per_episode` | 4.0625 |
...
| `robot_contacts_per_episode` | 26.375 |
| `recovery_events_per_episode` | 56.0625 |
| `block_steps_per_episode` | 0.0 |
| `base_rush_steps_per_episode` | 146.3125 |
| `wall_time_s` | 88.662 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/mappo_sidegate_rigidbody_seed505_strict16_rs015/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/mappo_sidegate_rigidbody_seed505_strict16_rs015/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/mappo_sidegate_rigidbody_seed505_strict16_rs015/strict_replay_events.jsonl`
