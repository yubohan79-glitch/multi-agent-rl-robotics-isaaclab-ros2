...
| `base_rush_steps_per_episode` | 192.6875 |
| `wall_time_s` | 101.569 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/expert_yellow_late2_visual_hull_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/expert_yellow_late2_visual_hull_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/expert_yellow_late2_visual_hull_strict16/strict_replay_events.jsonl`
