...
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 5.1875 |
...
| `base_rush_steps_per_episode` | 182.1875 |
| `wall_time_s` | 92.739 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/expert_yellow3_blue2_yfast_visual_hull_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/expert_yellow3_blue2_yfast_visual_hull_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/expert_yellow3_blue2_yfast_visual_hull_strict16/strict_replay_events.jsonl`
