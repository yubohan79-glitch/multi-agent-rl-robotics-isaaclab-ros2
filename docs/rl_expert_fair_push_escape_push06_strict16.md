...
| `base_rush_steps_per_episode` | 116.0 |
| `wall_time_s` | 73.273 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/expert_fair_push_escape_push06_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/expert_fair_push_escape_push06_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/expert_fair_push_escape_push06_strict16/strict_replay_events.jsonl`
