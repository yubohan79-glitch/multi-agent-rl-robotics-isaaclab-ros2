...
| `robot_contacts_per_episode` | 4.5 |
| `recovery_events_per_episode` | 12.0 |
| `block_steps_per_episode` | 0.0 |
| `base_rush_steps_per_episode` | 718.5 |
| `wall_time_s` | 45.903 |

## Output Files

- JSON summary: `isaaclab_sim/rl/isaaclab_sim/output/replay/contact_hull_fix_strict4/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/rl/isaaclab_sim/output/replay/contact_hull_fix_strict4/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/rl/isaaclab_sim/output/replay/contact_hull_fix_strict4/strict_replay_events.jsonl`
