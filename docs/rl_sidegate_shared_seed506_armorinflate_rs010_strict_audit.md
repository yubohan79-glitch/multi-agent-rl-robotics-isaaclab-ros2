...
- checkpoint: `isaaclab_sim/output/rl/mappo_sidegate_rigidbody_shared_seed506_rulefix/policy.pt`
- deterministic: `False`
- device: `cuda`
- episodes: `16`
...
| --- | ---: |
| `episodes` | 16 |
| `yellow_win_rate` | 0.625 |
| `blue_win_rate` | 0.3125 |
| `draw_or_timeout_rate` | 0.0625 |
| `hard_violations` | 0 |
| `warnings` | 172 |
| `normal_hits_per_episode` | 5.6875 |
| `base_wins_per_episode` | 0.9375 |
| `own_target_penalties_per_episode` | 0.0 |
| `blocked_steps_per_episode` | 0.0 |
| `target_contact_events_per_episode` | 0.0 |
| `robot_contacts_per_episode` | 27.125 |
| `recovery_events_per_episode` | 3.9375 |
| `block_steps_per_episode` | 0.0 |
| `base_rush_steps_per_episode` | 171.875 |
| `wall_time_s` | 85.909 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/mappo_sidegate_shared_seed506_armorinflate_rs010_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/mappo_sidegate_shared_seed506_armorinflate_rs010_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/mappo_sidegate_shared_seed506_armorinflate_rs010_strict16/strict_replay_events.jsonl`
