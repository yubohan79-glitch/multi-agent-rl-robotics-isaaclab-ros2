...
- checkpoint: `/mnt/c/Users/Administrator/Desktop/作品集/RoboCupVisionRL_IsaacLab_ROS2/isaaclab_sim/output/rl/mappo_offaxis_base_ros2_gpu_seed121/policy.pt`
- deterministic: `False`
- device: `cuda`
- episodes: `16`
...
| --- | ---: |
| `episodes` | 16 |
| `yellow_win_rate` | 0.4375 |
| `blue_win_rate` | 0.5 |
| `draw_or_timeout_rate` | 0.0625 |
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 1.625 |
...
| `recovery_events_per_episode` | 63.4375 |
| `block_steps_per_episode` | 0.0 |
| `base_rush_steps_per_episode` | 176.4375 |
| `wall_time_s` | 42.628 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/mappo_offaxis_base_seed121_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/mappo_offaxis_base_seed121_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/mappo_offaxis_base_seed121_strict16/strict_replay_events.jsonl`
