...
- checkpoint: `isaaclab_sim/output/rl/mappo_sensorfusion_embodied_balanced_gpu/policy.pt`
- deterministic: `False`
- device: `cuda`
- episodes: `16`
...
| `recovery_events_per_episode` | 50.5 |
| `block_steps_per_episode` | 0.0 |
| `base_rush_steps_per_episode` | 97.125 |
| `wall_time_s` | 41.919 |

## Output Files

- JSON summary: `isaaclab_sim/rl/isaaclab_sim/output/replay/mappo_sensorfusion_embodied_balanced_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/rl/isaaclab_sim/output/replay/mappo_sensorfusion_embodied_balanced_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/rl/isaaclab_sim/output/replay/mappo_sensorfusion_embodied_balanced_strict16/strict_replay_events.jsonl`
