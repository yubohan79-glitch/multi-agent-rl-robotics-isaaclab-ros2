...
| `block_steps_per_episode` | 6.375 |
| `base_rush_steps_per_episode` | 195.75 |
| `wall_time_s` | 72.91 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/mappo_dual_experts_contact_hull_seed260507_strict8/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/mappo_dual_experts_contact_hull_seed260507_strict8/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/mappo_dual_experts_contact_hull_seed260507_strict8/strict_replay_events.jsonl`
