...
| --- | ---: |
| `episodes` | 64 |
| `yellow_win_rate` | 0.5469 |
| `blue_win_rate` | 0.4062 |
| `draw_or_timeout_rate` | 0.0469 |
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 4.0 |
| `base_wins_per_episode` | 0.9531 |
...
| `base_rush_steps_per_episode` | 175.7812 |
| `wall_time_s` | 49.98 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/mappo_rule45_dwell_push_balanced_strict64/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/mappo_rule45_dwell_push_balanced_strict64/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/mappo_rule45_dwell_push_balanced_strict64/strict_replay_events.jsonl`
