...
- checkpoint: `isaaclab_sim/output/rl/mappo_dual_yellow_blue_experts_seed260506_rs004/policy.pt`
- deterministic: `False`
- device: `cuda`
- episodes: `8`
...
| `recovery_events_per_episode` | 12.375 |
| `block_steps_per_episode` | 0.0 |
| `base_rush_steps_per_episode` | 244.5 |
| `wall_time_s` | 66.972 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/mappo_dual_yellow_blue_experts_seed260506_rs004_strict8/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/mappo_dual_yellow_blue_experts_seed260506_rs004_strict8/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/mappo_dual_yellow_blue_experts_seed260506_rs004_strict8/strict_replay_events.jsonl`
