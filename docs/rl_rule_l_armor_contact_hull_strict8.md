...
- checkpoint: `/mnt/c/Users/Administrator/Desktop/作品集/RoboCupVisionRL_IsaacLab_ROS2/isaaclab_sim/output/rl/mappo_dual_experts_contact_hull_seed260507/policy.pt`
- deterministic: `False`
- device: `cpu`
- episodes: `8`
...
| `robot_contacts_per_episode` | 5.0 |
| `recovery_events_per_episode` | 0.0 |
| `block_steps_per_episode` | 0.0 |
| `base_rush_steps_per_episode` | 245.875 |
| `wall_time_s` | 75.051 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/mappo_dual_experts_contact_hull_seed260507_rule_l_armor_strict8/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/mappo_dual_experts_contact_hull_seed260507_rule_l_armor_strict8/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/mappo_dual_experts_contact_hull_seed260507_rule_l_armor_strict8/strict_replay_events.jsonl`
