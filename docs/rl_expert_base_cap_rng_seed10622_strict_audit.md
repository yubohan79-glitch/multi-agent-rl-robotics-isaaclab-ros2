...
- checkpoint: `/mnt/c/Users/Administrator/Desktop/作品集/RoboCupVisionRL_IsaacLab_ROS2/isaaclab_sim/output/rl/mappo_dual_experts_post_retry_bluetempo_rs005_seed261020/policy.pt`
- deterministic: `True`
- device: `cuda`
- episodes: `1`
...
| `base_rush_steps_per_episode` | 146.0 |
| `wall_time_s` | 13.095 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/expert_base_cap_rng_seed10622/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/expert_base_cap_rng_seed10622/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/expert_base_cap_rng_seed10622/strict_replay_events.jsonl`
