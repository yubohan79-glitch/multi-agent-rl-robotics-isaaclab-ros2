...
| `blue_win_rate` | 0.6875 |
| `draw_or_timeout_rate` | 0.0 |
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 1.875 |
...
| `robot_contacts_per_episode` | 26.5 |
| `recovery_events_per_episode` | 2.3125 |
| `block_steps_per_episode` | 8.125 |
| `base_rush_steps_per_episode` | 126.75 |
| `wall_time_s` | 28.803 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/mappo_recessed_base_boxmove_final_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/mappo_recessed_base_boxmove_final_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/mappo_recessed_base_boxmove_final_strict16/strict_replay_events.jsonl`
