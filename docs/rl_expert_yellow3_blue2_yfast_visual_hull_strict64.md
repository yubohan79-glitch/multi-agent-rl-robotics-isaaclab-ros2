...
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 5.3125 |
...
| `base_rush_steps_per_episode` | 205.2969 |
| `wall_time_s` | 410.497 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/expert_yellow3_blue2_yfast_visual_hull_strict64/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/expert_yellow3_blue2_yfast_visual_hull_strict64/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/expert_yellow3_blue2_yfast_visual_hull_strict64/strict_replay_events.jsonl`
