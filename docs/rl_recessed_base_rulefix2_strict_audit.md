...
| `robot_contacts_per_episode` | 30.5 |
| `recovery_events_per_episode` | 0.0625 |
| `block_steps_per_episode` | 3.0625 |
| `base_rush_steps_per_episode` | 220.625 |
| `wall_time_s` | 21.669 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/mappo_recessed_base_rulefix2_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/mappo_recessed_base_rulefix2_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/mappo_recessed_base_rulefix2_strict16/strict_replay_events.jsonl`
