...
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 3.9531 |
...
| `base_rush_steps_per_episode` | 111.2812 |
| `wall_time_s` | 287.895 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/expert_fair_push_escape_push06_strict64/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/expert_fair_push_escape_push06_strict64/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/expert_fair_push_escape_push06_strict64/strict_replay_events.jsonl`
