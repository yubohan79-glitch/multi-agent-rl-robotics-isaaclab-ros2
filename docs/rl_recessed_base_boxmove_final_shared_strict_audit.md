...
- checkpoint: `isaaclab_sim/output/rl/mappo_recessed_base_boxmove_final_shared_gpu_seed371/policy.pt`
- deterministic: `False`
- device: `cuda`
- episodes: `16`
...
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 1.9375 |
...
| `robot_contacts_per_episode` | 27.375 |
| `recovery_events_per_episode` | 0.0625 |
| `block_steps_per_episode` | 0.6875 |
| `base_rush_steps_per_episode` | 118.3125 |
| `wall_time_s` | 28.264 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/mappo_recessed_base_boxmove_final_shared_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/mappo_recessed_base_boxmove_final_shared_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/mappo_recessed_base_boxmove_final_shared_strict16/strict_replay_events.jsonl`
