...
- JSON summary: `isaaclab_sim/output/replay/expert_yellow_behind2_visual_hull_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/expert_yellow_behind2_visual_hull_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/expert_yellow_behind2_visual_hull_strict16/strict_replay_events.jsonl`
