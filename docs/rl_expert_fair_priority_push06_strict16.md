...
| `blue_win_rate` | 0.25 |
| `draw_or_timeout_rate` | 0.4375 |
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 3.9375 |
| `base_wins_per_episode` | 0.5625 |
...
| `base_rush_steps_per_episode` | 824.125 |
| `wall_time_s` | 106.496 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/expert_fair_priority_push06_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/expert_fair_priority_push06_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/expert_fair_priority_push06_strict16/strict_replay_events.jsonl`
