...
- device: `cuda`
- episodes: `16`
- training innovation: reset-time Sim2Real domain randomization + geometry-aware action shield
...
| `robot_contacts_per_episode` | 28.25 |
| `recovery_events_per_episode` | 0.25 |
| `block_steps_per_episode` | 1.75 |
| `base_rush_steps_per_episode` | 126.0625 |
| `wall_time_s` | 37.438 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/mappo_drshield_recessed_base_seed419_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/mappo_drshield_recessed_base_seed419_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/mappo_drshield_recessed_base_seed419_strict16/strict_replay_events.jsonl`
