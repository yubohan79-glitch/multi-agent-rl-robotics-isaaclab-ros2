...
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 2.5 |
| `base_wins_per_episode` | 1.0 |
| `own_target_penalties_per_episode` | 0.0 |
| `blocked_steps_per_episode` | 310.25 |
| `target_contact_events_per_episode` | 0.0 |
| `robot_contacts_per_episode` | 0.0 |
| `recovery_events_per_episode` | 0.375 |
| `block_steps_per_episode` | 0.0 |
| `base_rush_steps_per_episode` | 120.25 |
| `wall_time_s` | 38.431 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/expert_base_cap_rng_physical_boxes_strict8/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/expert_base_cap_rng_physical_boxes_strict8/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/expert_base_cap_rng_physical_boxes_strict8/strict_replay_events.jsonl`
