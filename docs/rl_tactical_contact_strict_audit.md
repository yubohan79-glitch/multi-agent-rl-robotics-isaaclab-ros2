...
| `hard_violations` | 0 |
| `warnings` | 43 |
| `normal_hits_per_episode` | 3.8125 |
| `base_wins_per_episode` | 0.9375 |
| `own_target_penalties_per_episode` | 0.0 |
| `blocked_steps_per_episode` | 0.625 |
| `target_contact_events_per_episode` | 2.6875 |
| `robot_contacts_per_episode` | 0.0 |
| `recovery_events_per_episode` | 0.0 |
| `block_steps_per_episode` | 7.3125 |
| `base_rush_steps_per_episode` | 361.25 |
| `wall_time_s` | 28.676 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/mappo_tactical_contact_open_gate_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/mappo_tactical_contact_open_gate_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/mappo_tactical_contact_open_gate_strict16/strict_replay_events.jsonl`
