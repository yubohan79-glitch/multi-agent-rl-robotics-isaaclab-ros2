...
- checkpoint: `isaaclab_sim/output/rl/mappo_ros2_drift_basehard_gpu_seed79/policy.pt`
- deterministic: `False`
- device: `cuda`
- episodes: `8`
...
| `recovery_events_per_episode` | 108.0 |
| `block_steps_per_episode` | 29.0 |
| `base_rush_steps_per_episode` | 2349.375 |
| `wall_time_s` | 74.978 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/mappo_ros2_drift_basehard_seed79_strict8/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/mappo_ros2_drift_basehard_seed79_strict8/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/mappo_ros2_drift_basehard_seed79_strict8/strict_replay_events.jsonl`
