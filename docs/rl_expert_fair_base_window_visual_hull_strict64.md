...
| --- | ---: |
| `episodes` | 64 |
| `yellow_win_rate` | 0.6562 |
| `blue_win_rate` | 0.3438 |
| `draw_or_timeout_rate` | 0.0 |
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 4.4219 |
...
| `base_rush_steps_per_episode` | 158.0469 |
| `wall_time_s` | 310.29 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/expert_fair_base_window_visual_hull_strict64/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/expert_fair_base_window_visual_hull_strict64/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/expert_fair_base_window_visual_hull_strict64/strict_replay_events.jsonl`
