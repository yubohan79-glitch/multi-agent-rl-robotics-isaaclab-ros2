...
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 4.1875 |
...
| `base_rush_steps_per_episode` | 170.5625 |
| `wall_time_s` | 65.635 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/expert_fair_push_escape_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/expert_fair_push_escape_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/expert_fair_push_escape_strict16/strict_replay_events.jsonl`
