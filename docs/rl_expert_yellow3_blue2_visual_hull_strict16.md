...
| `base_rush_steps_per_episode` | 182.9375 |
| `wall_time_s` | 104.407 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/expert_yellow3_blue2_visual_hull_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/expert_yellow3_blue2_visual_hull_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/expert_yellow3_blue2_visual_hull_strict16/strict_replay_events.jsonl`
