...
| `hard_violations` | 0 |
| `warnings` | 0 |
| `normal_hits_per_episode` | 4.3125 |
...
| `base_rush_steps_per_episode` | 181.25 |
| `wall_time_s` | 96.586 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/expert_blue_gate_first_visual_hull_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/expert_blue_gate_first_visual_hull_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/expert_blue_gate_first_visual_hull_strict16/strict_replay_events.jsonl`
