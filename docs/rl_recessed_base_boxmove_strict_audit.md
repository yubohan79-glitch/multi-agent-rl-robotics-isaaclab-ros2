...
| `blocked_steps_per_episode` | 85.375 |
| `target_contact_events_per_episode` | 0.0 |
| `robot_contacts_per_episode` | 30.0 |
| `recovery_events_per_episode` | 0.5 |
| `block_steps_per_episode` | 3.75 |
| `base_rush_steps_per_episode` | 90.5 |
| `wall_time_s` | 29.227 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/mappo_recessed_base_boxmove_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/mappo_recessed_base_boxmove_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/mappo_recessed_base_boxmove_strict16/strict_replay_events.jsonl`
