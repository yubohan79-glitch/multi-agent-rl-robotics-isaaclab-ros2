...
| `target_contact_events_per_episode` | 1.5625 |
| `robot_contacts_per_episode` | 0.0 |
| `recovery_events_per_episode` | 0.0 |
| `block_steps_per_episode` | 0.25 |
| `base_rush_steps_per_episode` | 204.75 |
| `wall_time_s` | 22.901 |

## Output Files

- JSON summary: `isaaclab_sim/output/replay/mappo_tactical_contact_open_gate_boxtrace_strict16/strict_replay_summary.json`
- CSV trace: `isaaclab_sim/output/replay/mappo_tactical_contact_open_gate_boxtrace_strict16/strict_replay_trace.csv`
- JSONL event log: `isaaclab_sim/output/replay/mappo_tactical_contact_open_gate_boxtrace_strict16/strict_replay_events.jsonl`
